...
namespace SpiderRock
{
	namespace DataFeed
	{
		...
		public:
			...
			void CreateThreadGroup(std::initializer_list<DataChannel> channels);
			void Start();
			...
			void RegisterObserver(std::shared_ptr<CreateEventObserver<SpreadQuote>> observer);
			...
			void RegisterObserver(std::shared_ptr<ChangeEventObserver<SpreadQuote>> observer);
			...
			void RegisterObserver(std::shared_ptr<UpdateEventObserver<SpreadQuote>> observer);
