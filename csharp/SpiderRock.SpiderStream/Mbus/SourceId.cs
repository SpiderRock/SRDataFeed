...
public struct SourceId : IEquatable<SourceId>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(SourceId left, SourceId right) => left.Equals(right);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >(SourceId left, SourceId right) => left.value.CompareTo(right.value) > 0;
