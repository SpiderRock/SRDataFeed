...
internal unsafe struct TickerLayout : IEquatable<TickerLayout>, IComparable<TickerLayout>, IEquatable<string>
{
    ...
    public override readonly bool Equals(object obj) => obj is TickerLayout other && Equals(other);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(TickerLayout other)
    {
        unchecked
        {
            int x, y, r;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(TickerLayout other)
    {
    ...
    {
        var length = maxLength >= 12 ? 12 : maxLength;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(TickerLayout left, TickerLayout right) => left.Equals(right);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(TickerLayout left, TickerLayout right) => !left.Equals(right);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(TickerLayout x, TickerLayout y) => x.CompareTo(y) < 0;
