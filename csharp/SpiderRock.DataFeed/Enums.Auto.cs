...
namespace SpiderRock.DataFeed
{
	...
	public enum AdjConvention : byte { None=0,Original=1,OSI=2,SpcOnly=3,OSIAlt=4 };		
 	...
 	public enum OptExch : byte { None=0,AMEX=1,BOX=2,CBOE=3,ISE=4,NYSE=5,PHLX=6,NSDQ=7,BATS=8,C2=9,NQBX=10,MIAX=11,GMNI=12,CME=13,CBOT=14,NYMEX=15,COMEX=16,ICE=17,EDGO=18,MCRY=19,MPRL=20,SDRK=21,DQTE=22,EMLD=23,CFE=24,MEMX=25,SPHR=26,EUREX=27,CEDX=28,NXAM=29,NXBR=30,NXLS=31,NXML=32,NXOS=33,NXP=34,ICEFEC=35,ICEFEF=36,TMX=37 };		
 	...
 	public enum PrimaryExchange : byte { None=0,NYSE=1,NYSEArca=2,NYSEMkt=3,NASDAQ=4,NASDAQBOS=5,BATS=6,PHLX=7,IEXG=8,CSE=9,NSE=10,FINRA=11,PORTAL=12,OTC=13,CME=14,CBOT=15,NYMEX=16,COMEX=17,ICE=18,EUREX=19,XETRA=20,CDEX=21,BXE=22,CXE=23,DXE=24,LSE=25,NXAM=26,NXBR=27,NXLS=28,NXML=29,NXOS=30,NXP=31,XTSE=32 };		
 	...
 	public enum StkPriceInc : byte { None=0,FullPenny=1,Nickle=2,HalfPenny=3 };		
 	...
 	public enum TickerSrc : byte { None=0,SR=1,NMS=2,CME=3,ICE=4,CFE=5,CBOT=6,TD=7,NYMEX=8,COMEX=9,RUT=10,CBOE=11,ISE=12,ARCA=13,NYSE=14,OTC=15,TST1=16,TST2=17,TST3=18,TST=19,USR1=20,USR2=21,USR3=22,NSDQ=23,MFQS=24,PHLX=25,MIAX=26,TSE=27,DJI=28,CBX=29,BXE=30,SCE=31,CXE=32,DXE=33,NXAM=34,NXBR=35,NXLS=36,NXML=37,NXOS=38,NXP=39,EUREX=40,CEDX=41,ICEFEC=42,ICEFEF=43,TSX=44,TMX=45 };		
