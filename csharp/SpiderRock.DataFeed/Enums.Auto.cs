...
namespace SpiderRock.DataFeed
{
	...
	public enum AdjConvention : byte { Original=0,OSI=1,SpcOnly=2,OSIAlt=3 };		
 	...
 	public enum ContractUnit : byte { None=0,AUD=1,BBL=2,BDFT=3,BRL=4,BU=5,CAD=6,CHF=7,CTRCT=8,CWT=9,CZK=10,EUR=11,GAL=12,GBP=13,HUF=14,ILS=15,IPNT=16,JPY=17,KRW=18,LBS=19,MMBTU=20,MWH=21,MXN=22,MYR=22,NOK=23,NZD=24,PLN=25,RMB=26,RUR=27,SEK=28,TON=29,TRY=31,TRYOZ=32,USD=33,ZAR=34 };		
 	...
 	public enum LiveSurfaceType : byte { None=0,Live=1,Hist=2,PriorDay=3,Skew=4,LiveSkew=5,LiveAdj=6,Interp=7,Test1=8,Test2=9,Test3=10,LiveC=11,BaseC=12,PrevC=13,HistC=14,InterpC=15,Default=16,BaseEMA_1=17,BaseEMA_2=18,BaseEMA_3=19 };		
 	...
 	public enum OptExch : byte { None=0,AMEX=1,BOX=2,CBOE=3,ISE=4,NYSE=5,PHLX=6,NSDQ=7,BATS=8,C2=9,NQBX=10,MIAX=11,GMNI=12,CME=13,CBOT=14,NYMEX=15,COMEX=16,ICE=17,EDGO=18,MCRY=19,MPRL=20,SDRK=21,DQTE=22,MEMLD=23 };		
 	...
 	public enum PrimaryExch : byte { None=0,NYSE=1,AMEX=2,Nasdaq=3,NasdaqSmallCap=4,OtcBB=5,Index=6,ARCA=7,CME=8,CBOT=9,NYMEX=10,COMEX=11,ICE=12,BATS=13,IEXG=14 };		
 	public enum ProductClass : byte { Equity=1,Index=2,Future=3,Option=4,Spread=5 };		
 	...
 	public enum SpdrKeyType : byte { None=0,Stock=1,Future=2,Option=3 };		
