...
namespace SpiderRock.DataFeed
{
	...
	public partial class FutureBookQuote
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return fkey ?? (fkey = ExpiryKey.GetCreateExpiryKey(body.fkey)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.fkey = value.Layout; fkey = value; }
			}
	...
	public partial class IndexQuote
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return ticker ?? (ticker = TickerKey.GetCreateTickerKey(body.ticker)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.ticker = value.Layout; ticker = value; }
			}
	...
	public partial class LiveImpliedQuote
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return okey ?? (okey = OptionKey.GetCreateOptionKey(body.okey)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.okey = value.Layout; okey = value; }
			}
	...
	public partial class LiveSurfaceAtm
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return ekey ?? (ekey = ExpiryKey.GetCreateExpiryKey(body.ekey)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.ekey = value.Layout; ekey = value; }
			}

			public LiveSurfaceType SurfaceType
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.surfaceType; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.surfaceType = value; }
			}
	...
	public partial class OptionExchPrint
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.srPrintID; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.srPrintID = value; }
			}
	...
	public partial class OptionImpliedQuote
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.calcType; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.calcType = value; }
			}
	...
	public partial class ProductDefinitionV2
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return secKey ?? (secKey = OptionKey.GetCreateOptionKey(body.secKey)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.secKey = value.Layout; secKey = value; }
			}
			/// <summary>Security Type [Stock, Future, Option]</summary>
			public SpdrKeyType SecType
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.secType; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.secType = value; }
			}
	...
	public partial class RootDefinition
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return root ?? (root = TickerKey.GetCreateTickerKey(body.root)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.root = value.Layout; root = value; }
			}
	...
	public partial class SpdrAuctionState
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.srAuctionID; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.srAuctionID = value; }
			}
	...
	public partial class SpreadBookQuote
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return skey ?? (skey = TickerKey.GetCreateTickerKey(body.skey)); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.skey = value.Layout; skey = value; }
			}
			/// <summary>Yes indicates that response is made of entirely of isTest=Yes SpreadExchOrders</summary>
			public YesNo IsTest
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.isTest; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.isTest = value; }
			}
	...
	public partial class SpreadExchOrder
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return orderID ?? (orderID = body.orderID); }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.orderID = value; orderID = value; }
			}
	...
	public partial class StockExchImbalanceV2
	{
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.auctionTime; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.auctionTime = value; }
			}

			public AuctionReason AuctionType
			{
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				get { return body.auctionType; }
				[MethodImpl(MethodImplOptions.AggressiveInlining)]
				set { body.auctionType = value; }
			}
