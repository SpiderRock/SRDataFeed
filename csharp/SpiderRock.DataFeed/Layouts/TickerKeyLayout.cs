...
namespace SpiderRock.DataFeed.Layouts
{
    ...
    internal struct TickerKeyLayout : IEquatable<TickerKeyLayout>, IComparable<TickerKeyLayout>
    {
        ...
        public bool Equals(TickerKeyLayout other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(TickerKeyLayout left, TickerKeyLayout right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator <(TickerKeyLayout x, TickerLayout y)
        {
