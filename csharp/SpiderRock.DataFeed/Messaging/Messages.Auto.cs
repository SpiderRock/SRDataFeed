...
namespace SpiderRock.DataFeed.Messaging
{
    ...
    public partial class FutureBookQuote
    {
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			/// <summary>Comment missing!</summary>
			public FutureKey Fkey
			{
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)] set { body.fkey = value; fkey = value; }
			}
    ...
    public partial class FutureSettlementMark
    {
		...
		/// <summary>Comment missing!</summary>
		public DateKey SettleDate { get { return CacheVar.AllocIfNull(ref settleDate).Get(ref body.settleDate, usn); } set { CacheVar.AllocIfNull(ref settleDate).Set(value); body.settleDate = value; } }
    ...
    public partial class LiveSurfaceAtm
    {
		...
		/// <summary>Comment missing!</summary>
		public StockKey Ticker { get { return CacheVar.AllocIfNull(ref ticker).Get(ref body.ticker, usn); } set { CacheVar.AllocIfNull(ref ticker).Set(value); body.ticker = value; } }
		...
		public FutureKey SFKey { get { return CacheVar.AllocIfNull(ref sFKey).Get(ref body.sFKey, usn); } set { CacheVar.AllocIfNull(ref sFKey).Set(value); body.sFKey = value; } }
 		/// <summary>Comment missing!</summary>
    ...
    public partial class OptionCloseMark
    {
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			public OptionKey Okey
			{
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)] set { body.okey = value; okey = value; }
			}
    ...
    public partial class SpreadQuote
    {
		...
		public sealed class PKey : IEquatable<PKey>, ICloneable
		{
			...
			public StockKey Ticker
			{
				...
				[MethodImpl(MethodImplOptions.AggressiveInlining)] set { body.ticker = value; ticker = value; }
			}
 			/// <summary>Comment missing!</summary>
		...
		public OptionKey Okey1 { get { return CacheVar.AllocIfNull(ref okey1).Get(ref body.okey1, usn); } set { CacheVar.AllocIfNull(ref okey1).Set(value); body.okey1 = value; } }
 		/// <summary>Comment missing!</summary>
		...
		public OptionKey Okey2 { get { return CacheVar.AllocIfNull(ref okey2).Get(ref body.okey2, usn); } set { CacheVar.AllocIfNull(ref okey2).Set(value); body.okey2 = value; } }
 		/// <summary>Comment missing!</summary>
		...
		public OptionKey Okey3 { get { return CacheVar.AllocIfNull(ref okey3).Get(ref body.okey3, usn); } set { CacheVar.AllocIfNull(ref okey3).Set(value); body.okey3 = value; } }
 		/// <summary>Comment missing!</summary>
		...
		public OptionKey Okey4 { get { return CacheVar.AllocIfNull(ref okey4).Get(ref body.okey4, usn); } set { CacheVar.AllocIfNull(ref okey4).Set(value); body.okey4 = value; } }
 		/// <summary>Comment missing!</summary>
		...
		public OptionKey Okey5 { get { return CacheVar.AllocIfNull(ref okey5).Get(ref body.okey5, usn); } set { CacheVar.AllocIfNull(ref okey5).Set(value); body.okey5 = value; } }
 		/// <summary>Comment missing!</summary>
		...
		public OptionKey Okey6 { get { return CacheVar.AllocIfNull(ref okey6).Get(ref body.okey6, usn); } set { CacheVar.AllocIfNull(ref okey6).Set(value); body.okey6 = value; } }
 		/// <summary>Comment missing!</summary>
