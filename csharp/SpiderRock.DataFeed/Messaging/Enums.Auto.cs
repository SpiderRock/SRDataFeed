...
namespace SpiderRock.DataFeed.Messaging
{
	...
	public enum BuySell : byte { None=0,Buy=1,Sell=2 };		
 	...
 	public enum MarkSource : byte { None=0,NbboMid=1,SRVol=2,LoBound=3,HiBound=4,SRPricer=5 };		
 	...
 	public enum QuoteType : byte { New=0,Modify=1,Delete=2,Print=3,Internal=4 };		
 	public enum SettleTime : byte { None=0,PM=1,AM=2 };		
 	public enum SprdSource : byte { None=0,Internal=1,ISE=2,CBOE=3,PHLX=4 };		
