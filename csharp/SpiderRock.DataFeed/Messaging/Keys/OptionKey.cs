...
{
    public class OptionKey : IComparable<OptionKey>, IEquatable<OptionKey>, IKeyEquatable<OptionKeyLayout>
    {
        ...
        bool IKeyEquatable<OptionKeyLayout>.Equals(ref OptionKeyLayout other)
        {
